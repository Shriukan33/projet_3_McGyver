...
def main():
    ...
    while running:
        ...
        while game.main_game:
            ...
            interaction_check(game)
            screen_update(clock, FPS, SCREEN, game)
        ...
        while game.win_screen:
            ...
            render_win_screen(clock, SCREEN, FPS)
